    ...
    <Box sx={{ marginTop: "80px" }}>
      <Container>
        ...
        <Grid container spacing={4} mt={4}>
          ...
          <Grid item xs={12} md={4} data-aos="fade-right" data-aos-delay="140">
            <EventCard />
          </Grid>
          <Grid item xs={12} md={4} data-aos="fade-right" data-aos-delay="160" sx={{display:{xs:cond?"block":"none",md:"block"}}}>
            <EventCard />
          </Grid>
          <Grid item xs={12} md={4} data-aos="fade-right" data-aos-delay="180" sx={{display:{xs:cond?"block":"none",md:"block"}}}>
            <EventCard />
          </Grid>
          <Grid item xs={12} md={4} data-aos="fade-right" data-aos-delay="200" sx={{display:{xs:cond?"block":"none",md:"block"}}}>
            <EventCard />
          </Grid>
        </Grid>
