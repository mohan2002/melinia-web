    ...
    <Box >
      ...
      <Container sx={{display:"flex",marginTop:"80px",xflexDirection:"column",flexWrap:"wrap",justifyContent:"space-between",gap:"30px",alignItems:"center"}}>
        <Box width="100%" display="flex" alignItems="center" justifyContent="center" mb={4}>
          <Typography variant="h4" sx={{fontSize:{xs:"26px",md:"36px"}}} fontWeight="700">COMMITTE MEMBERS</Typography>
        </Box>
        <Box width="100%" display="flex" alignItems="center" justifyContent="center">
          <CommitteeProfileCard img="/images/stanley.jpg" name="Dr.C.Stanly Felix" position="Faculty Advisor" designation="Department of Computing" phone=" 0422-2574071 Extn: 335" mail="stanlyfelix@cit.edu.in"/>
        </Box>
        <Box width="100%"  display="flex" flexDirection={{xs:"column",md:"row"}}  alignItems="center" justifyContent="space-around" gap={4}>
          <CommitteeProfileCard img="/images/dd.jpeg" name="J Danesh Dheerthan" position="Chairman" designation="Msc Decision and Computing Science" phone="9842398623" mail="1933005mdcs@cit.edu.in"/>
        ...
        <Box width="100%"  display="flex" alignItems="center" justifyContent="center">
         <CommitteeProfileCard img="/images/dd.jpeg" name="Shri Haritha" position="Treasurer" designation="Msc DataScience" phone="9842398623" mail="1933005mdcs@cit.edu.in"/>
        </Box>
        <Box width="100%"  display="flex" flexDirection={{xs:"column",md:"row"}} alignItems="center" justifyContent="space-around" gap={4}>
